...
public class PanelAdmin extends JPanel {
    ...
    private JButton btnAsignar, btnEliminar, btnExportarCSV, btnExportarUsuariosCSV, btnVerDetalles;
    ...
    private void exportarCSV() {
        ...
        if (opcion == JFileChooser.APPROVE_OPTION) {
            try (PrintWriter writer = new PrintWriter(fileChooser.getSelectedFile())) {
                writer.println("ID,Título,Descripción,Cliente,Fecha Creación,Fecha Asignación,Fecha Resolución,Respuesta");
    ...
    private void verDetallesIncidencia() {
        int fila = tabla.getSelectedRow();
        if (fila == -1) {
            JOptionPane.showMessageDialog(this, "Selecciona una incidencia para ver detalles.", "Aviso", JOptionPane.WARNING_MESSAGE);
            return;
        }
